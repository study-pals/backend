...
/**
 * Redis에 저장된 {@link UserSubscirbeInfo} 엔티티에 접근하기 위한 Repository 인터페이스입니다.
 * <p>
 ...
 */
@Repository
public interface UserSubscribeInfoRepository extends RedisHashRepository<UserSubscirbeInfo, String> {}
