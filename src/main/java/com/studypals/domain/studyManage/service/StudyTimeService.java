...
/**
 * 공부 시간 시작/종료 및 통계를 위한 반환, 수정, 삭제 등
 * 관리에 있어서 전반적인 역할을 당당합니다.
 *
 * <p><b>상속 정보:</b><br>
...
public interface StudyTimeService {
     ...
     * <pre>
     * 0. 해당 메서드의 매개변수인 startStudyReq 는 categoryId 와 temporaryName이 동시에 존재하면 안됩니다.
     ...
     *
     * -> 컨트롤러 혹은 클라이언트는 보낸 시간과, 반환받은 시작 시간을 비교하여 기존에 공부 중이었는지 여부를 파악할 수 있습니다.
     * </pre>
