...
include::{snippets}/category-controller-rest-docs-test/create_success/response-fields.adoc[]
...
include::{snippets}/category-controller-rest-docs-test/update_success/response-fields.adoc[]
...
include::{snippets}/category-controller-rest-docs-test/delete_success/response-fields.adoc[]
...
include::{snippets}/category-controller-rest-docs-test/delete-all_success/response-fields.adoc[]
