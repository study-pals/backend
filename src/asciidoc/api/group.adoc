...
include::{snippets}/group-entry-controller-rest-docs-test/accept-entry-request_success/request-fields.adoc
...
include::{snippets}/group-study-controller-rest-docs-test/get-group-daily-goal_success/response-headers.adoc
