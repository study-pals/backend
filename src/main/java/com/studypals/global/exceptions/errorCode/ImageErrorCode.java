 ...
 * ImageException ImageException}에서 사용되며, <br>
...
public enum ImageErrorCode implements ErrorCode {
    IMAGE_NOT_FOUND(ResponseCode.IMAGE_UPLOAD, "can't find image", HttpStatus.NOT_FOUND),
    IMAGE_EXTENSION_NOT_ACCEPTABLE(
            ResponseCode.IMAGE_ACCESS, "image extension should be jpg, jpeg, or png.", HttpStatus.BAD_REQUEST);
